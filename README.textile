...
* Services with a @media_api_id@ also have a @media_api_type@, which indicates what sort of API call should be made (be it photo, video, media, set, album, or playlist)
