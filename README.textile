...
* A direct media url for Youtube, Photobucket, Twitpic, Imageshack (@http://img#{num}.imageshack.us/img#{num}/#{NUMBER}/#{IMAGENAME}@ format), Vimeo (Individuals videos, not albums), and flickr (@http://farm#{num}.static.flickr.com/@ format)
